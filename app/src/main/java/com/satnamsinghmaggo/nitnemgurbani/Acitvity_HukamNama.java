...
public class Acitvity_HukamNama extends AppCompatActivity {
    ...
    private static final String pdfURL = "https://hs.sgpc.net/pdfdownload.php?id=261";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar.show();  // Show initially
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (!response.isSuccessful() || response.body() == null) {
                    runOnUiThread(() -> {
                        progressBar.hide();
                        Toast.makeText(Acitvity_HukamNama.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
                    });
                    return;
                }
                ...
                try (InputStream inputStream = response.body().byteStream();
                    ...
                    runOnUiThread(() -> {
                        progressBar.hide();
                        Toast.makeText(Acitvity_HukamNama.this, "Error processing PDF", Toast.LENGTH_SHORT).show();
                    });
                }
            }
        });
